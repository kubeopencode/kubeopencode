...
└── ContextSpec
    ├── type: ContextType (Inline, ConfigMap, Git, Runtime)
...
type ContextItem struct {
    Type      ContextType       // Inline, ConfigMap, Git, or Runtime
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `spec.type` | ContextType | Yes | Type of context: Inline, ConfigMap, Git, or Runtime |
