...
export const mockTasks: Task[] = [
  ...
  },
  {
    ...
    session: {
      id: 'ses_abc123def456',
      title: 'kubeopencode/default/add-user-profile/a1b2c3d4',
      summary: {
        messageCount: 12,
        tokenUsage: { input: 45200, output: 18300, reasoning: 5200, cache: 12800 },
        cost: '0.0842',
        filesChanged: 5,
        additions: 187,
        deletions: 23,
  ...
  },
  {
    ...
    session: {
      id: 'ses_xyz789abc012',
      title: 'kubeopencode/default/refactor-api-handlers/e5f6a7b8',
      summary: {
        messageCount: 24,
        tokenUsage: { input: 128500, output: 67200, reasoning: 15800, cache: 45600 },
        cost: '0.2134',
        filesChanged: 12,
        additions: 456,
        deletions: 289,
  ...
  },
  {
    ...
    session: {
      id: 'ses_fail456def',
      title: 'kubeopencode/default/update-deps/c3d4e5f6',
      summary: {
        messageCount: 8,
        tokenUsage: { input: 32100, output: 12400, reasoning: 3200 },
        cost: '0.0456',
        filesChanged: 2,
        additions: 34,
        deletions: 12,
  ...
  },
  {
    ...
    session: {
      id: 'ses_test789ghi',
      title: 'kubeopencode/default/write-unit-tests/g7h8i9j0',
      summary: {
        messageCount: 18,
        tokenUsage: { input: 89400, output: 41200, reasoning: 8900, cache: 28700 },
        cost: '0.1523',
        filesChanged: 8,
        additions: 342,
        deletions: 15,
