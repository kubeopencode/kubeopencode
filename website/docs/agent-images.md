...
sidebar_position: 3
title: Agent Images
description: Building and customizing agent images for KubeOpenCode
---
...
- [Agent Developer Guide](https://github.com/kubeopencode/kubeopencode/tree/main/agents) - Detailed agent development
